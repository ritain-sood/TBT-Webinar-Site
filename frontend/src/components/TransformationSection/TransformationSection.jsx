...
const TransformationSection = () => {
  ...
  const features = [
    ...
    },
    {
      title: "Resources",
      description:
        "Receive exclusive PDFs, templates & trading tools post-session.",
      isHighlighted: false,
    },
  ];
        ...
        {features.map((feature, index) => {
          ...
          return (
            ...
            >
              ...
              {!feature.isHighlighted && (
                <div className="md:hidden absolute inset-0 rounded-full"></div>
              )}
              ...
              <div className="w-[80px] h-[80px] md:w-[140px] md:h-[140px] relative">
                <img
                  ...
                  className={`w-full h-full object-contain ${
                    feature.isHighlighted ? "" : "opacity-50 md:opacity-100"
                  }`}
                />
              </div>
