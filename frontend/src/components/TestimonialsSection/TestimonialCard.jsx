...
//   return (
//     <div className="bg-[#1C1C1C] rounded-[20px] flex flex-col h-full">
//       {/* Top content */}
...
//           ))}
//         </div>
//         <p className="text-white text-sm flex-1">{testimonial.text}</p>
//       </div>
...
//         <p className="text-black font-semibold text-sm">{testimonial.date}</p>
//       </div>
//     </div>
//   );
// };
