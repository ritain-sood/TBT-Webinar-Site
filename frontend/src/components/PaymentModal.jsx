...
//               className="w-full p-3 bg-[#2A2A2A] text-white rounded-md border border-gray-700 focus:outline-none focus:ring-2 focus:ring-[#FFC02B]"
//               required
//             />
//           </div>
...
//             type="submit"
//             disabled={loading}
//             className="w-full py-3 px-6 bg-[#FFC02B] text-black font-bold text-lg rounded-full hover:bg-yellow-400 transition-colors disabled:bg-gray-500 disabled:cursor-not-allowed"
//           >
