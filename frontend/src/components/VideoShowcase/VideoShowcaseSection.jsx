// // components/VideoShowcaseSection.jsx

// const VideoShowcaseSection = () => {
//   return (
//     <section className="max-w-6xl z-10 mt-[10%] mx-auto flex flex-col md:flex-row items-center gap-8 px-4">
        
//         {/* Video Box */}
//         <div className="relative md:h-[400px] rounded-[20px] p-[4px] bg-gradient-to-br from-[#FFD369] to-[#FFB800] shadow-[0_0_30px_#FFD369] order-2 md:order-1">
//           <div className="relative w-full h-full rounded-[16px] overflow-hidden">
//             <video
//               src="https://www.youtube.com/embed/Ifb_ClVzu7A?si=fy8b1zec2MjqwTZj"
//               controls
...
const VideoShowcaseSection = () => {
  ...
  return (
    <section className="max-w-6xl z-10 mt-[10%] mx-auto flex flex-col md:flex-row items-center gap-25 px-4">
        ...
        >
          {/* This div now has a black background to prevent the yellow flash */}
